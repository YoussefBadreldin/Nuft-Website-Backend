const { Faculties } = require('../models/FacultiesModel');
...
const deletefaculty = async function(req, res) {
    try {
        ...
        const result = await Faculties.deleteOne({ faculty: name });
...
module.exports = { addFacultiesfaculty, deletefaculty, getAllfaculty, };
