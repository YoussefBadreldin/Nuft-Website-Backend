...
const addprivateFacility = async function(req, res) {
    try {
        const {
            facilities,
...
const deleteFacility = async function(req, res) {
    try {
        ...
        const result = await private.deleteOne({ facilities: name });
...
const getAllfacilities = async function(req,res){
    try{
        const facilities = await private.find();
...
module.exports = { addprivateFacility, deleteFacility, getAllfacilities, };
