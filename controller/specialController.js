...
const addspecialFacility = async function(req, res) {
    try {
        const {
            facilities,
...
const deleteFacility = async function(req, res) {
    try {
        ...
        const result = await special.deleteOne({ facilities: name });
...
const getAllfacilities = async function(req,res){
    try{
        const facilities = await special.find();
...
module.exports = { addspecialFacility, deleteFacility, getAllfacilities, };
